        ...
        <div className="relative mx-auto grid min-h-[calc(100vh-72px)] max-w-7xl items-center gap-12 px-4 py-14 sm:px-6 sm:py-20 lg:grid-cols-[0.95fr_1.05fr] lg:px-8 lg:py-16">
          ...
          >
            ...
            <div className="mt-9 flex flex-wrap gap-3">
              <Link
                to="/products"
                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-violet-600 px-6 py-4 text-sm font-black text-white shadow-[0_18px_50px_rgba(124,58,237,0.3)] transition hover:-translate-y-0.5 hover:bg-violet-500"
              >
                Explore the store
                <FaArrowRight className="text-[10px]" />
              </Link>
              ...
              <Link
                to="/track-order"
                className="inline-flex items-center justify-center gap-2 rounded-2xl border border-white/10 bg-white/[0.05] px-6 py-4 text-sm font-black text-white/80 transition hover:border-white/20 hover:bg-white/[0.09] hover:text-white"
              >
            ...
            {[
              {
                ...
                text: "Final pricing is checked by the backend.",
              },
              {
                icon: FaTruck,
                title: "Clear delivery",
                text: "Delivery charges are visible before ordering.",
              },
              {
                icon: FaSyncAlt,
                title: "Live availability",
                text: "Stock follows the exact selected variant.",
              },
              {
                icon: FaStar,
                title: "Verified reviews",
                text: "Real delivered orders can leave feedback.",
              },
            ].map(({ icon: Icon, title, text }) => (
              <div key={title} className="flex gap-4 py-6 sm:px-6">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-white/[0.07] text-violet-300">
                  <Icon />
                </div>
                <div>
        ...
        <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
          <SectionHeading
            ...
            action={
              <Link
                to="/products"
                className="inline-flex w-fit items-center gap-2 text-sm font-black text-slate-700 transition hover:text-violet-600"
              >
                View all products
                <FaArrowRight className="text-[10px]" />
              </Link>
          ...
          >
            {categories.map((category, index) => {
              const representative =
                categoryProductMap.get(category.slug) ||
                allLoadedProducts[index % Math.max(allLoadedProducts.length, 1)];
      ...
      <section className="border-y border-slate-200 bg-white">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
          <SectionHeading
            ...
            action={
              <Link
                ...
                className="inline-flex w-fit items-center gap-2 rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-black text-slate-700 transition hover:border-slate-300 hover:bg-slate-50"
              >
                Shop all
                <FaArrowRight className="text-[10px]" />
              </Link>
          ...
          {loadError && featuredGrid.length === 0 ? (
            <div className="mt-10 rounded-[32px] border border-slate-200 bg-slate-50 px-6 py-14 text-center">
              <FaBoxOpen className="mx-auto text-2xl text-slate-300" />
              <p className="mt-4 text-sm font-bold text-slate-700">{loadError}</p>
            </div>
          ) : featuredGrid.length === 0 ? (
            <div className="mt-10 rounded-[32px] border border-slate-200 bg-slate-50 px-6 py-14 text-center">
              <FaShoppingBag className="mx-auto text-2xl text-slate-300" />
...
<section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
  <div className="mb-7 max-w-2xl">
    ...
    <p className="mt-3 max-w-xl text-sm leading-6 text-slate-500">
      A quick visual break highlighting products without overwhelming the page.
    </p>
  </div>

  <div className="grid gap-5 lg:grid-cols-[1.15fr_0.85fr]">
    <EditorialCard
      product={editorialPrimary}
      eyebrow="Featured edit"
      title="Products that deserve a closer look."
      className="min-h-[360px]"
    />

    <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-1">
      <EditorialCard
        product={editorialSecondary}
      ...
      <Link
        to="/products"
        className="group relative flex min-h-[220px] flex-col justify-between overflow-hidden rounded-[30px] bg-gradient-to-br from-violet-600 via-indigo-600 to-blue-600 p-6 text-white shadow-[0_20px_60px_rgba(79,70,229,0.16)]"
      >
        ...
        <div className="relative">
          ...
          <h3 className="mt-2 max-w-xs text-2xl font-black tracking-[-0.04em]">
      ...
      {newestGrid.length > 0 && (
        <section className="border-b border-slate-200 bg-white">
          <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
            <SectionHeading
              eyebrow="Just landed"
              title="New arrivals, front and center."
              description="Fresh products automatically appear here when they are added to the catalog."
              action={
                <Link
        ...
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          <div className="lg:sticky lg:top-28">
            ...
            <h2 className="mt-3 text-4xl font-black tracking-[-0.055em] text-slate-950 sm:text-5xl">
              Less guessing.
              <span className="block text-slate-400">More shopping.</span>
            </h2>
            <p className="mt-5 max-w-md text-sm leading-7 text-slate-500 sm:text-base">
              The experience is built so shoppers can understand the product,
              choose the exact version they want and know what happens after
              checkout.
            </p>

            <Link
              to="/products"
              className="mt-7 inline-flex items-center gap-2 rounded-2xl bg-slate-950 px-5 py-3.5 text-sm font-black text-white transition hover:bg-violet-700"
            >
              Start shopping
              <FaArrowRight className="text-[10px]" />
            </Link>
            ...
            {[
              {
                ...
                text: "Customers choose the actual available size, color or product option before ordering.",
              },
              {
                icon: FaBoxOpen,
                number: "02",
                title: "Live inventory",
                text: "Availability follows real variant stock instead of a generic product-level guess.",
              },
              {
                icon: FaMapMarkerAlt,
                number: "03",
                title: "Transparent delivery",
                text: "Product-specific delivery charges are shown before the order is placed.",
              },
              {
                icon: FaLock,
                number: "04",
                title: "Server-checked totals",
                text: "Important order values are recalculated by the backend instead of trusting the browser.",
              },
              {
                icon: FaTruck,
                number: "05",
                title: "Order tracking",
                text: "Customers can return with their order number and contact to follow fulfillment.",
              },
              {
                icon: FaStar,
                number: "06",
                title: "Verified feedback",
                text: "Only customers with delivered orders can submit a verified-purchase review.",
              },
            ].map(({ icon: Icon, number, title, text }) => (
              <motion.div
                key={title}
                variants={reveal}
                className="group rounded-[30px] border border-slate-200 bg-white p-6 shadow-[0_14px_45px_rgba(15,23,42,0.035)] transition hover:-translate-y-1 hover:border-violet-200 hover:shadow-[0_22px_70px_rgba(79,70,229,0.08)] sm:p-7"
              >
          ...
          <div className="grid overflow-hidden rounded-[42px] border border-slate-200 bg-[#f4e8df] shadow-[0_28px_90px_rgba(15,23,42,0.10)] lg:grid-cols-[0.88fr_1.12fr]">
            <div className="flex flex-col justify-center p-7 sm:p-10 lg:p-14">
              ...
              <h2 className="mt-4 text-4xl font-black tracking-[-0.055em] text-slate-950 sm:text-5xl">
                A store that feels good to explore.
              </h2>

              <p className="mt-5 max-w-lg text-sm leading-7 text-slate-600 sm:text-base">
                ShopEase brings fashion, footwear, accessories and everyday
                essentials into one clean experience where products stay at the
                center of attention.
              </p>
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                <Link
                  to="/products"
                  className="inline-flex items-center justify-center gap-2 rounded-2xl bg-slate-950 px-5 py-3.5 text-sm font-black text-white transition hover:-translate-y-0.5 hover:bg-violet-700"
                >
                ...
                <Link
                  to="/wishlist"
                  className="inline-flex items-center justify-center gap-2 rounded-2xl border border-slate-300 bg-white/70 px-5 py-3.5 text-sm font-black text-slate-700 transition hover:bg-white"
                >
            ...
            <div className="relative min-h-[390px] overflow-hidden bg-slate-100 sm:min-h-[480px] lg:min-h-[560px]">
              ...
              <div className="absolute bottom-5 right-5 rounded-2xl border border-white/35 bg-white/80 px-4 py-3 backdrop-blur-md sm:bottom-7 sm:right-7">
      ...
      <section className="bg-[#f6f6f4]">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-28">
          <div className="grid gap-12 lg:grid-cols-[0.86fr_1.14fr] lg:items-start">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-violet-100 bg-violet-50 px-3.5 py-2 text-[10px] font-black uppercase tracking-[0.18em] text-violet-700">
                <FaQuestionCircle className="text-[10px]" />
                Quick answers
              </div>

              <h2 className="mt-5 max-w-lg text-4xl font-black tracking-[-0.055em] text-slate-950 sm:text-5xl">
                Questions shouldn&apos;t interrupt the shopping.
              </h2>

              <p className="mt-5 max-w-md text-sm leading-7 text-slate-500 sm:text-base">
                Find the essentials here, then open the full help pages whenever
                ...
                {[
                  {
                    to: "/faq",
                    label: "View all FAQs",
                    text: "Answers to common shopping questions.",
                  },
                  {
                    to: "/shipping",
                    label: "Shipping & delivery",
                    text: "See how delivery works before ordering.",
                  },
                  {
                    to: "/returns",
                    label: "Returns & refunds",
                    text: "Review the current return guidance.",
                  },
                  {
                    to: "/contact",
                    label: "Contact support",
                    text: "Reach out when you need direct help.",
                  },
                ].map((item) => (
                  <Link
                    key={item.to}
                    to={item.to}
                    className="group flex items-center justify-between gap-4 rounded-[22px] border border-slate-200 bg-white px-5 py-4 transition hover:-translate-y-0.5 hover:border-violet-200 hover:shadow-[0_16px_50px_rgba(79,70,229,0.08)]"
                  >
                    <div>
                    ...
                    <FaArrowRight className="shrink-0 text-[10px] text-slate-300 transition group-hover:translate-x-1 group-hover:text-violet-600" />
                  </Link>
                ))}
              </div>
            </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-full border transition ${
                          isOpen
                            ? "rotate-180 border-violet-200 bg-violet-50 text-violet-600"
                    ...
                    >
                      <div className="overflow-hidden">
                        <p className="px-4 pb-6 text-sm leading-7 text-slate-500 sm:px-5">
                          {faq.answer}
                        </p>
                      </div>
                    </div>
                ...
                <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    ...
                    <p className="mt-2 text-lg font-black">
                      We&apos;ve kept support one click away.
                    </p>
                  </div>

                  <Link
                    to="/contact"
                    className="inline-flex shrink-0 items-center justify-center gap-2 rounded-2xl bg-white px-5 py-3 text-sm font-black text-slate-950 transition hover:bg-violet-100"
                  >
      ...
      <section className="border-y border-slate-200 bg-white">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
          <div className="relative overflow-hidden rounded-[40px] bg-[#0b0d12] px-6 py-10 text-white shadow-[0_30px_100px_rgba(15,23,42,0.14)] sm:px-10 sm:py-12 lg:px-14">
            <div className="absolute -right-20 -top-28 h-80 w-80 rounded-full bg-violet-600/30 blur-3xl" />
            <div className="absolute -bottom-24 right-[30%] h-64 w-64 rounded-full bg-blue-600/20 blur-3xl" />

            <div className="relative grid items-center gap-8 lg:grid-cols-[1fr_auto]">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.06] px-3.5 py-2 text-[10px] font-black uppercase tracking-[0.18em] text-violet-300">
                  <FaTruck className="text-[10px]" />
                  Already ordered?
                </div>

                <h2 className="mt-5 max-w-2xl text-3xl font-black tracking-[-0.045em] sm:text-4xl lg:text-5xl">
                  Your order should never feel like it disappeared.
                </h2>

                <p className="mt-4 max-w-xl text-sm leading-7 text-white/50">
                  Check your current order status whenever you want with your
                  order number and the contact used at checkout.
                </p>
              </div>

              <Link
                to="/track-order"
                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-white px-6 py-4 text-sm font-black text-slate-950 transition hover:-translate-y-0.5 hover:bg-violet-100"
              >
                Track my order
                <FaArrowRight className="text-[10px]" />
              </Link>
      ...
      <section className="relative overflow-hidden bg-[#f6f6f4]">
        ...
        <div className="relative mx-auto max-w-5xl px-4 py-24 text-center sm:px-6 sm:py-28 lg:px-8 lg:py-32">
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-[20px] bg-slate-950 text-white shadow-[0_18px_50px_rgba(15,23,42,0.2)]">
            <FaShoppingBag />
          </div>
          ...
          <h2 className="mx-auto mt-4 max-w-3xl text-4xl font-black tracking-[-0.06em] text-slate-950 sm:text-5xl lg:text-6xl">
            The best part of the store might still be one scroll away.
          </h2>
          ...
          <p className="mx-auto mt-5 max-w-xl text-sm leading-7 text-slate-500 sm:text-base">
            {collectionCount > 0
              ? `${collectionCount} ${
                ...
                } currently available in the full ShopEase catalog.`
              : "Explore the complete ShopEase catalog and find what fits you."}
          </p>

          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link
              to="/products"
              className="inline-flex items-center justify-center gap-2 rounded-2xl bg-slate-950 px-7 py-4 text-sm font-black text-white transition hover:-translate-y-0.5 hover:bg-violet-700"
            >
              Explore ShopEase
              <FaArrowRight className="text-[10px]" />
            </Link>
            ...
            <Link
              to="/contact"
              className="inline-flex items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white px-7 py-4 text-sm font-black text-slate-700 transition hover:border-slate-300 hover:bg-slate-50"
            >
              <FaHeadset className="text-xs" />
              Need help?
            </Link>
